...
class HomePlot(models.Model):
    ...
    access = models.IntegerField(_('Accessibility'), choices=access_choices, help_text=_('Is this plot accessible all the time or only at certain times?'))
